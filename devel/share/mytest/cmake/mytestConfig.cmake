...
if("TRUE" STREQUAL "TRUE")
  set(mytest_SOURCE_PREFIX /home/wangsen/ros_test/src/mytest)
  set(mytest_DEVEL_PREFIX /home/wangsen/ros_test/devel)
  set(mytest_INSTALL_PREFIX "")
  set(mytest_PREFIX ${mytest_DEVEL_PREFIX})
else()
  set(mytest_SOURCE_PREFIX "")
  set(mytest_DEVEL_PREFIX "")
  set(mytest_INSTALL_PREFIX /home/wangsen/ros_test/install)
...
if(NOT "/home/wangsen/ros_test/src/mytest/include " STREQUAL " ")
  set(mytest_INCLUDE_DIRS "")
  set(_include_dirs "/home/wangsen/ros_test/src/mytest/include")
  if(NOT " " STREQUAL " ")
    set(_report "Check the issue tracker '' and consider creating a ticket if the problem has not been reported yet.")
  elseif(NOT " " STREQUAL " ")
    set(_report "Check the website '' for information and consider reporting the problem.")
  else()
    set(_report "Report the problem to the maintainer 'wangsen <wangsen@todo.todo>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mytest' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/wangsen/ros_test/src/mytest/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/wangsen/ros_test/devel/lib;/home/wangsen/test/devel/lib;/home/wangsen/3D-box/devel/lib;/home/wangsen/ros_test/devel/lib;/opt/ros/kinetic/lib)
...
set(depends "cv_bridge;image_transport;roscpp;sensor_msgs;std_msgs;message_runtime;pcl_ros;jsk_recognition_msgs;geometry_msgs")
foreach(depend ${depends})
  ...
  list(APPEND mytest_EXPORTED_TARGETS ${${mytest_dep}_EXPORTED_TARGETS})
endforeach()
